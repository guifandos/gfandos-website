...
<section class="hero" aria-label="Introduction">
  ...
  <div class="wrap hero-inner">
    <span class="eyebrow">Análisis cuantitativo de la biodiversidad · Ecología del movimiento · UCM</span>
    <h1>Guillermo Fandos</h1>
    <p class="hero-tagline">Estudiamos cómo se mueven los animales, dónde viven y cómo conservarlos.</p>
    <p class="hero-affil">Análisis cuantitativo de la biodiversidad, movimiento animal y conservación<br>Dpto. Biodiversidad, Ecología y Evolución · Universidad Complutense de Madrid</p>
...
<section class="databand" aria-label="Movimiento sobre una superficie de idoneidad de hábitat">
  ...
  <div class="wrap databand-text">
    ...
    <p>Los modelos de distribución de especies nos dicen dónde el hábitat es idóneo. Los datos de movimiento nos dicen si los animales llegan hasta allí. Nuestro trabajo une las dos cosas: superficies de idoneidad a escala continental y las trayectorias de aves y mamíferos individuales que las conectan.</p>
    ...
    <div class="stats-grid">
      <div class="stat"><span class="stat-n">234</span><span class="stat-l">especies de aves europeas con kernels de dispersión estandarizados</span></div>
      <div class="stat"><span class="stat-n">3</span><span class="stat-l">proyectos financiados activos, uno como investigador principal</span></div>
      <div class="stat"><span class="stat-n">16</span><span class="stat-l">TFM y TFG dirigidos desde 2021</span></div>
    </div>
  </div>
</section>
