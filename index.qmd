---
pagetitle: "Spatial ecology, animal movement and conservation"
description: "Research group in spatial ecology at Universidad Complutense de Madrid. We study animal movement and dispersal, biodiversity monitoring and modelling, and conservation under global change."
...
<section class="hero" aria-label="Introduction">
  ...
  <div class="wrap hero-inner">
    <span class="eyebrow">Spatial ecology · Universidad Complutense de Madrid</span>
    <h1>Guillermo Fandos</h1>
    <p class="hero-tagline">We study how animals move, where they live, and how to keep them there.</p>
    <p class="hero-affil">Research group in animal movement, biodiversity modelling and conservation<br>Dept. Biodiversidad, Ecología y Evolución</p>
    <div class="hero-actions">
      <a class="btn btn-primary" href="research/index.html">Our research</a>
      <a class="btn btn-outline-dark" href="people.html#join-the-group">Join the group</a>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="wrap wrap-narrow">
    ...
    <p class="lead-text">We are a small research group at Universidad Complutense de Madrid working on the processes that drive where animals occur and how they move. We combine fieldwork, large-scale data synthesis (bird ringing, citizen science, camera traps) and Bayesian modelling to answer questions in movement ecology, biogeography and conservation.</p>
    <p class="lead-text">The group is led by <strong>Guillermo Fandos</strong>, Assistant Professor at UCM, and works closely with partners at the University of Potsdam, the British Trust for Ornithology and the Swiss Ornithological Institute.</p>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="team-strip">
      ...
      <a class="member" href="people.html">
        ...
        <span><span class="name">David Notario</span><br><span class="role">MSc student · INTRADISP</span></span>
      </a>
      <a class="member" href="people.html">
        <span class="avatar avatar-initials" aria-hidden="true">CM</span>
        <span><span class="name">Claudia Mediavilla</span><br><span class="role">MSc student · RIMed-Fauna</span></span>
      </a>
      <a class="member" href="people.html">
  ...
  <div class="wrap">
    <div class="callout-join">
      <div>
        ...
        <p>We welcome motivated students for TFM, PhD and postdoctoral projects in spatial ecology, movement and quantitative methods. <a href="people.html#join-the-group">Read how to get in touch</a>.</p>
      </div>
