...
<section class="databand" aria-label="Movement over a habitat suitability surface">
  ...
  <div class="wrap databand-text">
    ...
    <p>Species distribution models tell us where habitat is suitable. Movement data tell us whether animals get there. Our work joins the two, and asks the question that matters for conservation: which populations will make it, which will not, and where action makes the difference.</p>
